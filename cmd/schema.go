...
func buildCommandSchema(cmd *cobra.Command, compact bool) CommandSchema {
	...
	if strings.Contains(name, "create") || strings.Contains(name, "add") || strings.Contains(name, "finish") || strings.Contains(name, "resolve") || strings.Contains(name, "login") || strings.Contains(name, "start") || strings.Contains(name, "close") || strings.Contains(name, "edit") || strings.Contains(name, "pause") || strings.Contains(name, "restart") || strings.Contains(name, "cancel") || strings.Contains(name, "activate") || strings.Contains(name, "assign") || strings.Contains(name, "review") || strings.Contains(name, "change") || strings.Contains(name, "suspend") || strings.Contains(name, "confirm") || strings.Contains(name, "restore") || strings.Contains(name, "hide") {
		effect = "write"
		risk = "medium"
	}
